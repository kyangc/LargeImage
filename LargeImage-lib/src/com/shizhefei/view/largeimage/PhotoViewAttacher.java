...
//
    ...
    private class ScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            Log.d("hhhh",
                    "detector.getPreviousSpanX():" + detector.getPreviousSpanX()
                            + " detector.getPreviousSpanY():" + detector.getPreviousSpanY());

            Log.d("hhhh", "detector.getCurrentSpanX():" + detector.getCurrentSpanX()
                    + " detector.getCurrentSpanY():" + detector.getCurrentSpanY());

            Log.d("hhhh", "detector.getFocusX():" + detector.getFocusX() + " detector.getFocusY():"
                    + detector.getFocusY());
